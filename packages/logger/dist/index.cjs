...
__export(index_exports, {
  ...
  createElasticsearchLogger: () => createElasticsearchLogger,
  createFastifyPlugin: () => createFastifyPlugin,
  createFileLogger: () => createFileLogger,
  createFilter: () => createFilter,
  createGrpcLoggerInterceptor: () => createGrpcLoggerInterceptor,
  createKoaLoggerMiddleware: () => createKoaLoggerMiddleware,
  createLogger: () => createLogger,
  createLoggerMiddleware: () => createLoggerMiddleware,
  createOutputAdapter: () => createOutputAdapter,
  createProductionLogger: () => createProductionLogger,
...
// src/logger.ts
var Logger = class _Logger extends import_events.EventEmitter {
  config;
  outputs = [];
  contextStorage = new import_async_hooks.AsyncLocalStorage();
  buffer = [];
  flushTimer;
  contextProvider;
  constructor(config = {}) {
...
var TracingLogger = class extends Logger {
  traceStorage = new import_async_hooks2.AsyncLocalStorage();
